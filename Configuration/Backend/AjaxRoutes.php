...
return [
    'check_dropbox_authenticate' => [
        'path' => 'typo3_dropbox/checkauthentication',
        'target' => \TheCodingOwl\Typo3Dropbox\Controller\DropboxController::class . '::checkAuthenticationAction'
    ]
];